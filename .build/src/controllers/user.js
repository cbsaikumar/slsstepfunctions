    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_1 = _a.sent();
                return [2 /*return*/, {
                        statusCode: err_1.statusCode || 500,
...
exports.createAUser = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var User, user, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                User = (_a.sent()).User;
                return [4 /*yield*/, User.create(JSON.parse(event.body))];
            case 2:
                user = _a.sent();
                return [2 /*return*/, {
                        statusCode: 200,
